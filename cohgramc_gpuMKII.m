function [C,phi,S12,S1,S2,t,f]=backup_cohgramc_gpuMKII(data1,data2,movingwin,params,npairsession)
...
%    phi=gpuArray(zeros(nw,Nf,size(data1,3)));
   C=gpuArray(single(zeros(Nf,npairmass)));
   S12=C;
   S1=C;
   S2=C;
   phi=C;
else
   C=gpuArray(single(zeros(Nf,Ch,npairmass)));
   S12=C;
   S1=C;
   S2=C;
   phi=C;
