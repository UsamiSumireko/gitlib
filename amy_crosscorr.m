...
filtered1 = filter(MyFilt,1,double(eeg1)); %filters eeg1 between low_freq and high_freq
filtered2 = filter(MyFilt,1,double(eeg2)); %filters eeg2 between low_freq and high_freq
