function [C,phi,S12,S1,S2,f]=coherencyc_fft_gpu(gamydata,gV1data,params)
[~,pad,Fs,fpass,~,trialave]=getparams(params);
...
J1=fft(gamydata,nfft)/Fs;
J2=fft(gV1data,nfft)/Fs;
J1=J1(findx,:,:,:);
J2=J2(findx,:,:,:);
S12=squeeze(conj(J1).*J2);
S1=squeeze(conj(J1).*J1);
S2=squeeze(conj(J2).*J2);
